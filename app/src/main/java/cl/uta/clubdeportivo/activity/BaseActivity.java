...
import cl.uta.clubdeportivo.utility.PermissionUtils;
...
public class BaseActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_home) {
            ...
            finish();
        } else if (id == R.id.action_actdeportivas) {
            showAdThenActivity(ActDeportivasActivity.class, false);
        ...
        /*else if (id == R.id.action_share) {
            ...
            else if (id == R.id.action_mis_actividades) {
                ActivityUtils.getInstance().invokeActivity(mActivity, MisActDepActivity.class, false);
        }
